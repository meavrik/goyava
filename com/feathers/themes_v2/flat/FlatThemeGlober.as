...
package feathers.themes_v2.flat
{
	 ...
	 *
	 */
	public class FlatThemeGlober extends feathers.themes_v2.BaseFlatTheme
	{
		/**
		 * @private
		 */
		...
		[Embed(source="../assets/fonts/GloberSemiBoldFree.otf",fontFamily="GloberSemi",fontWeight="normal",mimeType="application/x-font",embedAsCFF="true")]
		protected static const FONT_EMBED_1:Class;
		
		[Embed(source="../assets/fonts/GloberSemiBoldFree.otf",fontFamily="GloberSemi",fontWeight="bold",mimeType="application/x-font",embedAsCFF="true")]
		protected static const FONT_EMBED_2:Class;
		
		[Embed(source="../assets/fonts/GloberSemiBoldFree.otf",fontFamily="GloberSemi",fontWeight="normal",unicodeRange="U+0030-U+0039",mimeType="application/x-font",embedAsCFF="false")]
		protected static const FONT_EMBED_3_NUMBER:Class;

		protected static const THEME_FONT_NAME_REGULAR:String = "GloberSemi";
		protected static const THEME_FONT_NAME_BOLD:String = "GloberSemi";

		/**
		 * Constructor.
		 */
		public function FlatThemeGlober(scaleToDPI:Boolean = true)
		{
