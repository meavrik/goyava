package subPanels 
{
	 ...
	 * @author Avrik
	 */
	public class AreYouSurePanel extends SubPanel 
	{
		...
		override protected function initialize():void 
		{
			...
			title = "Clear all items";// TextLocaleHandler.getText(TextsConsts.ExitAppTitle);
			
			this._messageLabel = new Label();
			this._messageLabel.text = "Are you sure?"//TextLocaleHandler.getText(TextsConsts.ExitAppMessage);
